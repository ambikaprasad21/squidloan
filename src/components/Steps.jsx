  ...
  return (
    <div className="relative w-72 h-72 p-6 text-white">
      ...
      >
        ...
        <path
          fill="url(#grad1)"
          d="M15 0C6.7 0 0 6.7 0 25V281C0 289.2 6.7 296 15 996H198C205.1 296 209.2 287.1 206.6 280.6C204.3 274.8 203 268.4 203 261.7C203 233.9 225.4 211.4 253 211.4C260.8 211.4 268.2 213.2 274.8 216.4C281.9 219.9 294 215.2 294 207.4V15C294 6.7 287.3 0 279 0H15Z"
        />
      </svg>
      <div className="relative flex flex-col gap-2 z-10 p-5">
